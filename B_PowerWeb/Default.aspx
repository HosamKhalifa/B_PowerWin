<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="Default.aspx.cs" Inherits="B_PowerWeb.Default" %>
...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <asp:ObjectDataSource ID="DashboardCardsDataSource" runat="server"
        DataObjectTypeName="B_PowerWeb.DashboardCard"
        TypeName="B_PowerWeb.DataProvider"
        SelectMethod="GetDashboardCards"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="IssuesDataSource" runat="server"
        DataObjectTypeName="B_PowerWeb.Issue"
        TypeName="B_PowerWeb.DataProvider"
        SelectMethod="GetIssues"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server"
        DataObjectTypeName="B_PowerWeb.SchedulerAppointment"
        TypeName="B_PowerWeb.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server"
        DataObjectTypeName="B_PowerWeb.SchedulerResource"
        TypeName="B_PowerWeb.ResourceDataSourceHelper"
