<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="EventScheduling.aspx.cs" Inherits="B_PowerWeb.EventScheduling" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
    <asp:PlaceHolder runat="server">
        <script src='<%= Page.ResolveUrl("~/Content/event-scheduling.js")%>' defer></script>
    </asp:PlaceHolder>
</asp:Content>
